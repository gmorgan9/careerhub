                ...
                <div class="card-container">
                    ...
                    <div class="card">
                        <div class="card-body text-center">
                            ...
                            <p class="card-text"><a href="<?php echo $app_link; ?>" target="_blank" class="badge text-bg-secondary text-decoration-none" style="margin-top: -10px !important; padding: none !important;">Visit Job Listing</a></p>
                        </div>
                    </div>
                </div>
