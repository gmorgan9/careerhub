                ...
                ?>
                        <tr>
                            ...
                            <td style="font-size: 20px;">
                                <a href="<?php echo BASE_URL; ?>/console/job/all-jobs/?jobviewid=<?php echo $id; ?>" class="view" data-bs-toggle="modal" data-bs-target="#viewModal<?php echo $id; ?>" style="text-decoration: none;">
