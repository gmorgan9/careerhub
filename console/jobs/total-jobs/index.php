        ...
        <table class="table text-white">
            ...
            <tbody>
                <?php
                    ...
                    $sql = "SELECT * FROM applications ORDER BY created_at DESC LIMIT $limit OFFSET $offset";
                ...
                <tr>
                    ...
                    <td style="font-size: 20px;">
                        <a href="<?php echo BASE_URL; ?>/console/jobs/offer-jobs/?viewid=<?php echo $id; ?>" class="view" data-bs-toggle="modal" data-bs-target="#viewModal<?php echo $id; ?>" style="text-decoration: none;">
