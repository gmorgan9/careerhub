                        ...
                        <div class="col-sm-12 col-md-4 portfolio-block">
                            <div class="project-description">
                                ...
                                <div class="share-buttons">
                                    ...
                                    <div class="btn-group">
                                        <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo $project_share_link; ?>" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;" class="btn" target="_blank" title="Share on Facebook">
                                            <i class="bi bi-facebook"></i>
                                        </a>
                                        <a href="https://twitter.com/share?url=<?php echo $project_share_link; ?>" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;" class="btn" target="_blank" title="Share on Twitter">
