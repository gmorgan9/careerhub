<div class="header">
    <h3 class="logo ms-3 me-3 pt-1">
        ...
        <!-- Logout button -->
        <div class="float-end end" style="margin-top: -5px !important;">
            <a href="<?php echo BASE_URL; ?>/search.php" class="badge text-bg-secondary mx-2 text-decoration-none fs-6" style="">Search</a>
