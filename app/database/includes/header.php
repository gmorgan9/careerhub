<div class="header">
        <h3 class="logo ms-3 me-3">
            ...
            <form class="float-end" action="logout_process.php" method="post"><button type="submit" name="logout" style="cursor:pointer;"><i class="bi bi-box-arrow-left fs-5"></i></button></form>
        </h3>
    </div>
<br>
