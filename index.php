...
<br>
    ...
    <!-- Top Row -->
        ...
        <!-- Open/Awaiting -->
            ...
            <div class="card top-card me-2">
                <a class="text-decoration-none text-black stretched-link" href="open-app.php">
                    <div class="card-body p-0">
                        <div class="left float-start" style="background-color: lightgreen; height: 100%; margin-left: -12px; border-top-left-radius: 0.325rem; border-bottom-left-radius: 0.325rem;">
